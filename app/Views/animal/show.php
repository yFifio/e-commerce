...
<div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <form action="/carrinho/add" method="post" class="mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100">Adotar</button>
                </form>
            </div>
        </div>
                ...
                <?php foreach ($relatedAnimals as $relatedAnimal): ?>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            ...
                            ?>
                            <a href="/animal?id=<?php echo $relatedAnimal['id']; ?>">
                                <img src="<?php echo htmlspecialchars($imageUrl); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($relatedAnimal['especie']); ?>" style="height: 225px; width: 100%; display: block; object-fit: cover;">
                            </a>
                            <div class="card-body">
    ...
    <?php else: ?>
        <div class="text-center py-5">
            <h1 class="display-4">Animal não encontrado</h1>
            <p class="lead">O animal que você está procurando não existe ou não está mais disponível.</p>
